...
from tikz import tikzTokenizer
...
class tikzConfig(PretrainedConfig):
    r"""
...
class tikzModel(PreTrainedModel):
    r"""
    ...
    """
    config_class = tikzConfig
    base_model_prefix = "nougat"

    def __init__(self, config: tikzConfig):
    ...
    def inference(
        ...
        output["predictions"] = self.decoder.tokenizer.batch_decode(output["sequences"])
        ...
        **kwargs,
        ...
        Args:
            model_path:
                Name of a pretrained model name either registered in huggingface.co. or saved in local.
        """
        model = super(tikzModel, cls).from_pretrained(
