...
from dataset import tikzDataset
from lightning_module import tikzDataPLModule, tikzModelPLModule
...
def train(config):
    """
    Train a tikz model using the provided configuration.
    ...
    model_module = tikzModelPLModule(config)
    data_module = tikzDataPLModule(config)
